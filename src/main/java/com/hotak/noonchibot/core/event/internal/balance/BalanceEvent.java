...
public sealed interface BalanceEvent extends CoreEvent {
    record SnapshotReceived(Map<String, AssetState> assets, Instant timestamp) implements BalanceEvent {}
    record UpdateReceived(Map<String, AssetState> assets, Instant timestamp) implements BalanceEvent {}
}
