...
@Slf4j
class DerivativeTradePoller implements LifecycleComponent {
    ...
    private List<TradeUpdateEvent> fetchAllTradeUpdatesForOrder(TradePollRequest tradePollRequest) {
        ...
        RestRequest request = RestRequest.builder()
                ...
                .pathUrl(DerivativeApiSpec.MY_TRADES_PATH_URL)
                .params(Map.of(
                        "category", "linear",
                        "symbol", symbol,
                ...
                .authRequired(true)
                .throttlerLimitId(DerivativeApiSpec.MY_TRADES_PATH_URL)
                .build();
