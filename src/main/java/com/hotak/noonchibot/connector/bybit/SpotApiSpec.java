...
final class SpotApiSpec {
    ...
    public static final String PLATFORM_NAME = "bybit";

    public static final String REST_BASE_URL = "https://api.bybit.com";
    public static final String WSS_URL = "wss://stream.bybit.com/v5/public/spot";
    ...
    public static final List<RateLimit> RATE_LIMITS = List.of(
            // 5초에 600회 per IP, 모든 HTTP 요청 공유
            RateLimit.pool("IP_TOTAL", 600, Duration.ofSeconds(5)),

            RateLimit.pool("UID_ORDER_CREATE", 20, Duration.ofSeconds(1)),
            RateLimit.pool("UID_ORDER_CANCEL", 20, Duration.ofSeconds(1)),
            ...
            RateLimit.pool("UID_FEE_RATE", 5, Duration.ofSeconds(1)),
