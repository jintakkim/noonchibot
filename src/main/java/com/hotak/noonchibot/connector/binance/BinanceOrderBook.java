...
public class BinanceOrderBook extends AbstractOrderBook implements OrderBook {
     ...
     */
    public OrderBookMessage.SnapshotMessage snapshotMessageFromExchange(JsonNode msg, Instant timestamp, String tradingPair) {
     ...
     */
    public OrderBookMessage.DiffMessage diffMessageFromExchange(JsonNode msg, Instant timestamp, String tradingPair) {
     ...
     */
    public OrderBookMessage.TradeMessage tradeMessageFromExchange(JsonNode msg, String tradingPair) {
